...
class MK12 extends StatefulWidget {
  const MK12({super.key});

  @override
  State<MK12> createState() => _TaskPageState();
}

class _TaskPageState extends State<MK12> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('tasks')
            .where('courseCode', isEqualTo: 'Biology-MK12')
            .snapshots(),
